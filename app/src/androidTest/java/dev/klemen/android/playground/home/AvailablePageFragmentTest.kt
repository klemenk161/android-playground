...
class AvailablePageFragmentTest {
    ...
    private val launchIntent = Intent(ApplicationProvider.getApplicationContext(), TestActivity::class.java)
        .apply {
            putExtra(TEST_ACTIVITY_KEY, TEST_PAGE_HOME_AVAILABLE)
        }
    ...
    fun correctSetup() {
        ...
        onView(withId(R.id.availablePageProgress)).check(matches(withText(R.string.progress_fetching)))
    ...
    fun taskSuccessful() {
        ...
        // Assert
        onView(withId(R.id.availablePageProgress)).check(matches(withText(R.string.task_success)))
    }
    ...
    fun taskFailed() {
        ...
        // Assert
        onView(withId(R.id.availablePageProgress)).check(matches(withText(R.string.task_failed)))
    }
